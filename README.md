...
2. Install dependencies:
   ...
   **Note for pipx users**: `pipx` is designed for installing Python applications in isolated environments, not project dependencies. Use `pip` (or `pip3`) to install the requirements for this project. If you don't have `pip` installed, you can install it using your system's package manager or download it from [pip.pypa.io](https://pip.pypa.io/en/stable/installation/).
...
- **Max Upload Size**: 100 MB (configurable in `app.py` via `MAX_CONTENT_LENGTH`)
